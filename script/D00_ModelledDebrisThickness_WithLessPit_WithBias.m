...
% tmeperature following6 scenarios:
...
%% Select nly ID time step of interest
...
%%
close all
load('D:\2_IRPeyto\b_data_process\Pit_process\ExcavationLocation_TIR.mat', 'ExcavationLocation_TIR')
ExcavationLocation_TIR(17,:)=nan;
PitLocIDX = ExcavationLocation_TIR;

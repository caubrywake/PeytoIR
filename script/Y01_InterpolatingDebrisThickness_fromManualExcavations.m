...
TIR1_time=TIR1_time-hours(8);% I am not sure why the time zone are mixed
...
D = importdata('a_data_raw\excavation\Manualexcavation_Peyto_20190806_short.txt');
d =  D.data;PitDepth=d(:, 3);
clear D d
% Load study slope ROI
load('b_data_process\Pit_process\ROIstudyslope.mat')

%% Extrapolating depth to study slope
% test 3 options
IDX = ExcavationLocation_TIR; % renaming variable
...
save('D:\2_IRPeyto\b_data_process\Pit_process\DebrisThickness_interpolated_studyslope.mat', 'DepthInterp')
dlmwrite('D:\2_IRPeyto\b_data_process\Pit_process\DebrisThickness_interpolated_studyslope.txt', 'DepthInterp')

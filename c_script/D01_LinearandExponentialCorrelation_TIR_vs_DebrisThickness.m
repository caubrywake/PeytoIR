%% Linear vs Exponential Correlation with Poor, Avg and Good scatter PLOTS
% This code plots the correlation between debris thickness and surface
% temperature following the two main type of fit: linar and epxoential
...
%% Curve fitting for linear and ecp for the three timestep
close all
